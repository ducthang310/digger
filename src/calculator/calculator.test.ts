...
// sửa lại expected của 2 case cuối, công thức tính hiện tại trả ra kết quả đúng
// Đoạn render image cần phải nhận thêm params là width, height của ảnh
// Đoạn generate ảnh cũng cần phải trả về kích thước của ảnh đó
